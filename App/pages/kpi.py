...
def get_content_kpi(value):
                            ...
                            html.Div(
                                ...
                                children=[
                                    ...
                                    html.Div(children =[
                                        ...
                                        dbc.Popover(
                                            dbc.PopoverBody(definitions["EBIT"]),
                                            target="info-button",
                                            trigger="click",
                                        ),
                                    ])
    ...
    gross_profit_api_data_df = pd.DataFrame(gross_profit_api_data, index=["Gross Profit"]).T
    if (gross_profit_api_data_df["Gross Profit"][0] != 0 and gross_profit_api_data_df["Gross Profit"][0] != "NaN"):
    ...
    fig_gross_profit.update_traces(marker_color="#19AD50", textposition="inside", texttemplate="%{text:.3s}")
    ...
    net_income_api_data_df = pd.DataFrame(net_income_api_data, index=["Net Income"]).T
    if (net_income_api_data_df["Net Income"][0] != 0 and net_income_api_data_df["Net Income"][0] != "NaN"):
